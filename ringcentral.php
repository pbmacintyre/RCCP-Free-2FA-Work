...
function ringcentral_add_plugin_links($links, $file) {
    if ( $file == plugin_basename(dirname(__FILE__).'/ringcentral.php') ) {
        $links[] = '<a href="https://paladin-bs.com/wp-content/uploads/2023/10/RingCentral_plugin_user_guide_1_6_5.pdf" target="_blank">' . esc_html__('User Guide', 'ringcentral') . '</a>';
    }
    return $links;
}
